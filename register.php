      ...
      <div align="center">
         ...
         <form method="POST" action="">
            ...
            <tr>
                  ...
                  <td>
                     <input type="text" placeholder="Votre firstname" id="firstname" name="firstname" value="<?php if(isset($firstname)) { echo $firstname; } ?>" />
                  </td>
               </tr>
               <tr>
                  <td align="right">
                  ...
                  <td>
                     <input type="text" placeholder="Votre lastname" id="lastname" name="lastname" value="<?php if(isset($lastname)) { echo $lastname; } ?>" />
                  </td>
               </tr>
               <tr>
                  <td align="right">
                  ...
                  <td>
                     <input type="text" placeholder="Votre username" id="username" name="username" value="<?php if(isset($username)) { echo $username; } ?>" />
                  </td>
               </tr>
               <tr>
                  <td align="right">
               ...
               <tr>
                  ...
                  <td>
                     <input type="email2" placeholder="Confirmez votre mail" id="email2" name="email2" value="<?php if(isset($email2)) { echo $email2; } ?>" />
                  </td>
               </tr>
               <tr>
                  <td align="right">
